...
if __name__ == "__main__":
    ...
    policy_hparam = dict(hidden_size=64, num_recurrent_layers=2, output_nonlin=to.tanh, use_cuda=True)
    ...
    critic_hparam = dict(hidden_size=64, num_recurrent_layers=2, output_nonlin=to.exp, use_cuda=True)
